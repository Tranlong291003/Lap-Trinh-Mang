            ...
            while (true) {
                ...
                switch (CMD) {
                    ...
                    case "CMD_SEND_FILE_ACCEPT": // Format:  CMD_SEND_FILE_ACCEPT [receiver] [Message]
                        ...
                        case "CMD_REMOVE":
                        /**
                         * CMD_REMOVE [clientUsername]
                         * Loại bỏ người dùng khỏi danh sách client và socket
                         */
                        String removedClient = st.nextToken();
                        main.removeFromTheList(removedClient);
                        main.appendMessage("[Client]: " + removedClient + " đã rời khỏi chatroom.!");
                        break;
